...
If you've [set up reverse proxy](reverse-proxy-setup.md), install the certificate into Apache or Nginx following its usage guide. Otherwise follow below guide to install the certificate into OneDev:
